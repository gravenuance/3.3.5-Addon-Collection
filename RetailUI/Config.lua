...
local function MakeScaleSetter(widgetName)
    return function(_, input)
        SaveUIFrameScale(input, widgetName)
    end
end

local function LoadAllDefaults()
        ...
        scale = {
            ...
            args  = {
                ...
                tot = {
                    ...
                    type         = "input",
                    order        = 3,
                    set          = MakeScaleSetter("targetOfTarget"),
                    dialogHidden = true,
                },
                pet = {
